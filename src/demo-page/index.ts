...
const slider2 = $('.js-slider-container_2 > .js-slider').sliderPlugin({isRangeSlider: false, isFlag: false, scaleQuantity: 6, max: 5}).data("sliderPlugin");
const slider3 = $('.js-slider-container_3 > .js-slider').sliderPlugin({min: -1, max: 1, step: 0.1, isRangeSlider: false}).data("sliderPlugin");
const slider4 = $('.js-slider-container_4 > .js-slider').sliderPlugin({isHorizontal: false, step: 250, max: 1500,  scaleQuantity: 7}).data("sliderPlugin");
const slider5 = $('.js-slider-container_5 > .js-slider').sliderPlugin({isHorizontal: false,isRangeSlider: false, step: 10, max: 100, min: -100}).data("sliderPlugin");
